...
- 本拡張またはその基盤に、利用者・大学・第三者に不利益を及ぼしうる**重大な不具合・脆弱性**が判明した場合、提供者は本拡張の全部または一部の機能を**予告なく一時停止**することがあります。
- **大学（またはその関連組織）から利用の停止・変更等の要請を受けた場合**、提供者はその要請に従い、本拡張の全部または一部の機能を**一時停止または終了**することがあります。
- 提供者は、その他運営上・技術上の理由により、本拡張の提供を予告なく変更・中断・終了することがあります。
- これらの停止・終了について、提供者は可能な範囲で利用者への周知に努めますが、停止・終了そのもの、およびそれに起因して生じた損害について責任を負いません。
